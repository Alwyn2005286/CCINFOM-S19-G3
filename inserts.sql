-- 1. Reference Cities
INSERT INTO `databasesystem`.`ref_cities` (`city_id`, `city_name`) VALUES
(4, 'Pasig'),
(5, 'Taguig'),
(6, 'Mandaluyong'),
(7, 'San Juan'),
...
INSERT INTO `databasesystem`.`establishment_owners` (`owner_id`, `first_name`, `last_name`) VALUES
(4, 'Henry', 'Sy'),
(5, 'Lucio', 'Tan'),
(6, 'Ramon', 'Ang'),
(7, 'Lance', 'Gokongwei'),
...
-- 3. Establishments
INSERT INTO `databasesystem`.`establishments` (`establishment_id`, `owner_id`, `establishment_name`, `city_id`) VALUES
(4, 4, 'Greenwich', 4),
(5, 5, 'Chowking', 5),
(6, 6, 'Red Ribbon', 6),
(7, 7, 'Goldilocks', 7),
...
-- 4. Inspectors
INSERT INTO `databasesystem`.`inspectors` (`inspector_id`, `first_name`, `last_name`) VALUES
(4, 'Jose', 'Rizal'),
(5, 'Andres', 'Bonifacio'),
(6, 'Emilio', 'Aguinaldo'),
(7, 'Apolinario', 'Mabini'),
...
INSERT INTO `databasesystem`.`ref_inspection_requirements` (`Requirement_Code`, `Title`, `Standard_Fine`, `Description`, `Weight`) VALUES
...
-- 6. Inspections
INSERT INTO `databasesystem`.`inspections` (`inspection_id`, `establishment_id`, `inspection_date`, `score`, `grade`, `remarks`) VALUES
...
INSERT INTO `databasesystem`.`assigned_inspectors` (`assignment_id`, `inspection_id`, `inspector_id`) VALUES
(4, 4, 4),
(5, 5, 5),
(6, 6, 6),
(7, 7, 7),
...
-- 8. Violations
INSERT INTO `databasesystem`.`violations` (`violation_id`, `inspection_id`, `Requirement_Code`, `remarks`, `status`) 
VALUES 
